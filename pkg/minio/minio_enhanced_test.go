...
// TestMinIO_PutWithContext tests the context-aware Put method
func TestMinIO_PutWithContext(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	err := m.PutWithContext(ctx, "key", bytes.NewReader([]byte("data")))
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_PutWithContext_Error(t *testing.T) {
	mockS3 := &mockS3Client{
...
// TestMinIO_PutWithMetadata tests storing objects with metadata
func TestMinIO_PutWithMetadata(t *testing.T) {
	mockS3 := &mockS3Client{
		putObjectOutput: &s3.PutObjectOutput{},
	}
	...
	err := m.PutWithMetadata(ctx, "key", bytes.NewReader([]byte("data")), metadata)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_PutWithMetadata_NilMetadata(t *testing.T) {
	mockS3 := &mockS3Client{
		putObjectOutput: &s3.PutObjectOutput{},
	}
	...
	err := m.PutWithMetadata(ctx, "key", bytes.NewReader([]byte("data")), nil)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_PutWithMetadata_Error(t *testing.T) {
	mockS3 := &mockS3Client{
		putObjectError: errors.New("upload error"),
	}
...
// TestMinIO_GetWithContext tests context-aware Get
func TestMinIO_GetWithContext(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	r, err := m.GetWithContext(ctx, "key")
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
	defer r.Close()
...
func TestMinIO_GetWithContext_Error(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	_, err := m.GetWithContext(ctx, "key")
	if err == nil {
		t.Fatal("expected error, got nil")
	}
}

// TestMinIO_GetMetadata tests metadata retrieval
func TestMinIO_GetMetadata(t *testing.T) {
	now := time.Now()
	mockS3 := &mockS3Client{
...
func TestMinIO_GetMetadata_MinimalFields(t *testing.T) {
	now := time.Now()
	mockS3 := &mockS3Client{
		headObjectOutput: &s3.HeadObjectOutput{
...
func TestMinIO_GetMetadata_Error(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	_, err := m.GetMetadata(ctx, "key")
	if err == nil {
		t.Fatal("expected error, got nil")
	}
}

// TestMinIO_UpdateMetadata tests metadata update
func TestMinIO_UpdateMetadata(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	err := m.UpdateMetadata(ctx, "key", metadata)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_UpdateMetadata_NilMetadata(t *testing.T) {
	mockS3 := &mockS3Client{
		copyObjectOutput: &s3.CopyObjectOutput{},
	}
	...
	err := m.UpdateMetadata(ctx, "key", nil)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_UpdateMetadata_Error(t *testing.T) {
	mockS3 := &mockS3Client{
...
// TestMinIO_DeleteWithContext tests context-aware Delete
func TestMinIO_DeleteWithContext(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	err := m.DeleteWithContext(ctx, "key")
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
}

func TestMinIO_DeleteWithContext_Error(t *testing.T) {
	mockS3 := &mockS3Client{
...
// TestMinIO_Exists tests object existence check
...
func TestMinIO_Exists_NotFound(t *testing.T) {
	mockS3 := &mockS3Client{
...
func TestMinIO_Exists_NotFound_404(t *testing.T) {
	mockS3 := &mockS3Client{
		headObjectError: errors.New("404 Not Found"),
	}
...
func TestMinIO_Exists_OtherError(t *testing.T) {
	mockS3 := &mockS3Client{
...
// TestMinIO_ListWithContext tests context-aware list
func TestMinIO_ListWithContext(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	keys, err := m.ListWithContext(ctx, "")
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestMinIO_ListWithContext_WithPagination(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	keys, err := m.ListWithContext(ctx, "prefix/")
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestMinIO_ListWithContext_Error(t *testing.T) {
	mockS3 := &mockS3Client{
	...
	_, err := m.ListWithContext(ctx, "")
	if err == nil {
		t.Fatal("expected error, got nil")
	}
}

// TestMinIO_ListWithOptions tests paginated list with options
func TestMinIO_ListWithOptions(t *testing.T) {
	now := time.Now()
	mockS3 := &mockS3Client{
		listObjectsV2Output: &s3.ListObjectsV2Output{
			Contents: []*s3.Object{
	...
	result, err := m.ListWithOptions(ctx, opts)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestMinIO_ListWithOptions_NilOptions(t *testing.T) {
	mockS3 := &mockS3Client{
		listObjectsV2Output: &s3.ListObjectsV2Output{
			Contents:    []*s3.Object{},
			IsTruncated: aws.Bool(false),
	...
	result, err := m.ListWithOptions(ctx, nil)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestMinIO_ListWithOptions_NilKey(t *testing.T) {
	mockS3 := &mockS3Client{
		listObjectsV2Output: &s3.ListObjectsV2Output{
			Contents: []*s3.Object{
	...
	result, err := m.ListWithOptions(ctx, &common.ListOptions{})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestMinIO_ListWithOptions_NilLastModified(t *testing.T) {
	mockS3 := &mockS3Client{
		listObjectsV2Output: &s3.ListObjectsV2Output{
			Contents: []*s3.Object{
				{
...
func TestMinIO_ListWithOptions_Error(t *testing.T) {
	mockS3 := &mockS3Client{
		listObjectsV2Error: errors.New("list error"),
	}
	...
	_, err := m.ListWithOptions(ctx, &common.ListOptions{})
	if err == nil {
		t.Fatal("expected error, got nil")
	}
}
