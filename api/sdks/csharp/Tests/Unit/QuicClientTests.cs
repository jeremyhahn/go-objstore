...
public class QuicClientTests : IDisposable
{
    ...
    public async Task Quic_Put_HttpStatus_MapsToCanonicalException(HttpStatusCode status, Type expected)
    {
    ...
    [Fact]
    public async Task Quic_HttpError_ExtractsServerErrorMessage()
    {
